---
name: hermes-skill-gif-search
description: Search and download GIFs from Tenor through a controlled command-line workflow. Use when the user explicitly requests this capability or a closely related task.
---
